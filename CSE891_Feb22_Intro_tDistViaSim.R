...
# Ian Dworkin, last updated February 3rd 2022
...
SamplingFunction_t <- function(n=100, mean=172, sd=5, hypothesis=172) {
...
samples_for_t <- data.frame(t(replicate(1000, 
    expr = SamplingFunction_t())))  # Replicating the sampler for t 


plot(density(samples_for_t$t), 
    lwd=2, xlab="t",xlim=c(-5,10), 
    main="simulated and theoretical values of t") # The distribution of t-values from repeated sampling
